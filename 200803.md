...
```
$ ansible mysql -i project -m copy -a "src=/etc/yum.repo.d/mariadb.repo dest=/etc/yum.repo.d/mariadb.repo" -b
...
$ ansible mysql -i project -m service -a 'name=mysqld state=started enabled=true'
```
